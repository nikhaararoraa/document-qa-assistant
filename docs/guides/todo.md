# Document Q&A Assistant — SEC Filings — implementation checklist
...
- [x] `POST /chat/threads/{thread_id}/stream` — accepts AI SDK message format, streams a stubbed assistant reply
...
- [x] AI SDK chat primitives pointed at `POST /chat/threads/{thread_id}/stream` with Supabase bearer token
